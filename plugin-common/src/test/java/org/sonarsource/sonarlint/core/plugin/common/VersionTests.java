...
class VersionTests {
  ...
  @Test
  void test_only_major() {
    Version version = Version.create("1");
    assertThat(version.getMajor()).isEqualTo(1);
  ...
  void test_equals_hashcode() {
    ...
    Version version1212S = Version.create("1.2.1.2-SNAPSHOT");

    assertThat(version12.equals(version12)).isTrue();
    assertThat(version12.equals(Version.create("1.2"))).isTrue();
    assertThat(version12).hasSameHashCodeAs(Version.create("1.2"));
    assertThat(version12.equals(version121)).isFalse();
    assertThat(version12.equals("foo")).isFalse();
    assertThat(version1212S.equals(Version.create("1.2.1.2-SNAPSHOT"))).isTrue();
    assertThat(version1212S.equals(Version.create("1.2.1.2-beta"))).isFalse();
    assertThat(version1212S.equals(Version.create("1.2.1.3-SNAPSHOT"))).isFalse();
    assertThat(version1212S.equals(Version.create("1.2.3.2-SNAPSHOT"))).isFalse();
    assertThat(version1212S.equals(Version.create("1.3.1.2-SNAPSHOT"))).isFalse();
    assertThat(version1212S.equals(Version.create("3.2.1.2-SNAPSHOT"))).isFalse();
  }
  ...
  @Test
  void isCompatible() {
    assertThat(Version.create("1.2.3-SNAPSHOT").isCompatibleWith(Version.create("1.2.3-beta"))).isTrue();
    assertThat(Version.create("1.2.3-SNAPSHOT").isCompatibleWith(Version.create("1.2.3.4-SNAPSHOT"))).isFalse();
  }

  @Test
  void satisfiesMinRequirement() {
    assertThat(Version.create("1.2.3").satisfiesMinRequirement(Version.create("1.2.3"))).isTrue();
    assertThat(Version.create("1.2.3").satisfiesMinRequirement(Version.create("1.2.4"))).isFalse();
    assertThat(Version.create("1.2.3-SNAPSHOT").satisfiesMinRequirement(Version.create("1.2.3"))).isTrue();
    assertThat(Version.create("1.2.3-SNAPSHOT").satisfiesMinRequirement(Version.create("1.2.4"))).isFalse();
  }
}
