...
import static org.sonarsource.sonarlint.core.plugin.common.load.SonarPluginRequirementsChecker.isCompatibleWith;
...
class SonarPluginRequirementsCheckerTests {
  ...
  SonarPluginManifest withMinSqVersion(@Nullable String version) {
