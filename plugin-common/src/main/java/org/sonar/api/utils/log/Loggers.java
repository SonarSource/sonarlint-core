...
import org.sonarsource.sonarlint.core.plugin.common.log.SonarLintLoggerFactory;
 ...
 * the logging to an {@link LogListener}.
 * The LogListener can be set dynamically at any time, for the executing thread.
 */
