...
public class PluginLocator {
  ...
  public static final String SONAR_DBD_PLUGIN_VERSION = "1.36.0.12985";
  ...
  public static Path getJavaSePluginPath() {
    return getValidPluginPath(SONAR_JAVA_SE_PLUGIN_JAR);
  }

  public static Path getDbdPluginPath() {
    return getValidPluginPath(SONAR_DBD_PLUGIN_JAR);
  }

  public static Path getDbdJavaPluginPath() {
    return getValidPluginPath(SONAR_DBD_JAVA_PLUGIN_JAR);
  }
