      ...
      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          ...
          .withRequestBody(equalToJson(
            "{\"issueReleaseKey\":\"" + scaIssueKey + "\",\"transitionKey\":\"CONFIRM\",\"comment\":\"" + comment + "\"}")));
    });
  }
    ...
    waitAtMost(2, SECONDS).untilAsserted(() -> {
      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          .withHeader("Content-Type", equalTo("application/json; charset=UTF-8"))
          .withRequestBody(equalToJson(
            "{\"issueReleaseKey\":\"" + scaIssueKey + "\",\"transitionKey\":\"ACCEPT\",\"comment\":\"This is acceptable\"}")));
    });
  }
    ...
    waitAtMost(2, SECONDS).untilAsserted(() -> {
      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          .withHeader("Content-Type", equalTo("application/json; charset=UTF-8"))
          .withRequestBody(equalToJson(
            "{\"issueReleaseKey\":\"" + scaIssueKey + "\",\"transitionKey\":\"SAFE\",\"comment\":\"This is safe\"}")));
    });
  }
  ...
  void it_should_handle_multiple_sca_issues_with_different_transitions(SonarLintTestHarness harness) {
    ...
    waitAtMost(2, SECONDS).untilAsserted(() -> {
      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          .withRequestBody(equalToJson(
            "{\"issueReleaseKey\":\"" + scaIssueKey1 + "\",\"transitionKey\":\"CONFIRM\"}")));

      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          .withRequestBody(equalToJson(
            "{\"issueReleaseKey\":\"" + scaIssueKey2 + "\",\"transitionKey\":\"ACCEPT\",\"comment\":\"License is acceptable\"}")));
    });
  }
    ...
    waitAtMost(2, SECONDS).untilAsserted(() -> {
      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          .withHeader("Content-Type", equalTo("application/json; charset=UTF-8"))
          .withRequestBody(equalToJson(
            "{\"issueReleaseKey\":\"" + scaIssueKey + "\",\"transitionKey\":\"ACCEPT\",\"comment\":\"Critical issue accepted\"}")));
    });
  }
    ...
    waitAtMost(2, SECONDS).untilAsserted(() -> {
      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          .withHeader("Content-Type", equalTo("application/json; charset=UTF-8"))
          .withRequestBody(equalToJson(
            "{\"issueReleaseKey\":\"" + scaIssueKey + "\",\"transitionKey\":\"ACCEPT\",\"comment\":\"" + longComment + "\"}")));
    });
  }
      ...
      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          ...
          .withRequestBody(equalToJson(String.format(
            "{\"issueReleaseKey\":\"%s\",\"transitionKey\":\"ACCEPT\",\"comment\":\"%s\"}",
            scaIssueKey, specialComment.replace("\"", "\\\"").replace("\n", "\\n").replace("\t", "\\t")
          ))));
    });
  }
    ...
    waitAtMost(2, SECONDS).untilAsserted(() -> {
      server.getMockServer()
        .verify(WireMock.postRequestedFor(urlEqualTo("/api/v2/sca/issues-releases/change-status"))
          .withHeader("Content-Type", equalTo("application/json; charset=UTF-8"))
          .withRequestBody(equalToJson(
            "{\"issueReleaseKey\":\"" + scaIssueKey + "\",\"transitionKey\":\"ACCEPT\",\"comment\":\"" + unicodeComment + "\"}")));
    });
  }
