...
public class SonarLintTestRpcServer implements SonarLintRpcServer {
  ...
  public SonarLintTestRpcServer(PipedOutputStream clientToServerOutputStream, PipedOutputStream serverToClientOutputStream, BackendJsonRpcLauncher serverLauncher, ClientJsonRpcLauncher clientLauncher) {
