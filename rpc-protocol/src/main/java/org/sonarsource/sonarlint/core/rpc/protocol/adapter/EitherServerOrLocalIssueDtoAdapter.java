...
public class EitherServerOrLocalIssueDtoAdapter extends TypeAdapter<TrackWithServerIssuesResponse.ServerOrLocalIssueDto> {


  private static final TypeToken<Either<ServerMatchedIssueDto, LocalOnlyIssueDto>> ELEMENT_TYPE = new TypeToken<>() {
  };

  private final EitherTypeAdapter<ServerMatchedIssueDto, LocalOnlyIssueDto> wrappedAdapter;
  ...
  public static class Factory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
      ...
      return (TypeAdapter<T>) new EitherServerOrLocalIssueDtoAdapter(gson, typeToken);
    }

  }

  public EitherServerOrLocalIssueDtoAdapter(Gson gson, TypeToken<?> typeToken) {
  ...
  @Override
  public TrackWithServerIssuesResponse.ServerOrLocalIssueDto read(JsonReader in) throws IOException {
