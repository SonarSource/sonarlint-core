...
public class BindingSuggestionDto {
  ...
  public BindingSuggestionDto(String connectionId, String sonarProjectKey, String sonarProjectName, boolean isFromSharedConfiguration, BindingSuggestionOrigin origin) {
