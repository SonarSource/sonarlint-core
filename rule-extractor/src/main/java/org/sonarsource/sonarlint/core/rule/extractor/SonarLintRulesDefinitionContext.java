...
public class SonarLintRulesDefinitionContext extends RulesDefinition.Context {
  ...
  public RulesDefinition.NewRepository createExternalRepository(String engineId, String language) {
    throw new UnsupportedOperationException("createExternalRepository");
  }
  ...
  public String currentPluginKey() {
    throw new UnsupportedOperationException("currentPluginKey");
  }

  @Override
  public void setCurrentPluginKey(@Nullable String pluginKey) {
    throw new UnsupportedOperationException("setCurrentPluginKey");
  }
}
