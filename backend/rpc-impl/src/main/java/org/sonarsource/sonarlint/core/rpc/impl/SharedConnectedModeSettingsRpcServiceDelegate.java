...
public class SharedConnectedModeSettingsRpcServiceDelegate extends AbstractRpcServiceDelegate implements SharedConnectedModeSettingsRpcService {
  protected SharedConnectedModeSettingsRpcServiceDelegate(SonarLintRpcServerImpl server) {
    super(server);
  }
