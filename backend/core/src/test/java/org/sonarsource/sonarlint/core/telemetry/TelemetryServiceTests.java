...
class TelemetryServiceTests {
  ...
  void should_increment_remote_url_counter_for_assisted_remote_url() {
    underTest.addedNewBinding(BindingMode.ASSISTED, BindingSuggestionOrigin.REMOTE_URL);
  ...
  void should_increment_project_name_counter_for_assisted_project_name() {
    underTest.addedNewBinding(BindingMode.ASSISTED, BindingSuggestionOrigin.PROJECT_NAME);
  ...
  void should_increment_shared_config_counter_for_assisted_shared_config() {
    underTest.addedNewBinding(BindingMode.ASSISTED, BindingSuggestionOrigin.SHARED_CONFIGURATION);
  ...
  void should_increment_properties_file_counter_for_assisted_properties_file() {
    underTest.addedNewBinding(BindingMode.ASSISTED, BindingSuggestionOrigin.PROPERTIES_FILE);
  ...
  void should_do_nothing_when_assisted_and_origin_null() {
    underTest.addedNewBinding(BindingMode.ASSISTED, null);
