...
class PluginsServiceTest {
  ...
  @Test
  void should_return_active_embedded_when_resolver_returns_active() {
  ...
  @Test
  void should_return_failed_when_resolver_returns_failed() {
  ...
  @Test
  void should_return_synced_sonar_cloud_when_resolver_returns_synced_cloud() {
