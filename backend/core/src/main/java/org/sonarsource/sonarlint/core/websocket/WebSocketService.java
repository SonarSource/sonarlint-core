...
public class WebSocketService {
  ...
  public void handleEvent(BindingConfigChangedEvent bindingConfigChangedEvent) {
    ...
    if (didChangeRegion(bindingConfigChangedEvent.getPreviousConfig(), bindingConfigChangedEvent.getNewConfig())) {
      executorService.execute(() -> {
        var previousRegion = ((SonarCloudConnectionConfiguration) connectionConfigurationRepository
        .getConnectionById(bindingConfigChangedEvent.getPreviousConfig().getConnectionId())).getRegion();
        webSocketsByRegion.get(previousRegion).forget(bindingConfigChangedEvent.getConfigScopeId());
