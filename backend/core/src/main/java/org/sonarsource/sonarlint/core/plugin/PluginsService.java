...
public class PluginsService {
  ...
  public LoadedPlugins getEmbeddedPlugins() {
    ...
    if (loadedEmbeddedPlugins == null) {
      ...
      var skippedPlugins = result.getPluginCheckResultByKeys().values().stream().filter(PluginRequirementsCheckResult::isSkipped)
  ...
  public LoadedPlugins getPlugins(String connectionId) {
    ...
    if (loadedPlugins == null) {
      ...
      skippedPluginsRepository.setSkippedPlugins(connectionId, result.getPluginCheckResultByKeys());
    }
