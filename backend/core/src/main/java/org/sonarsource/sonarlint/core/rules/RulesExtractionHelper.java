...
public class RulesExtractionHelper {
  ...
  public List<SonarLintRuleDefinition> extractEmbeddedRules() {
    ...
    return ruleExtractor.extractRules(pluginsService.getEmbeddedPlugins().getPluginInstancesByKeys(),
      languageSupportRepository.getAllEnabledLanguagesInStandaloneMode(), false, false);
  }
  ...
  public List<SonarLintRuleDefinition> extractRulesForConnection(String connectionId) {
    ...
    return ruleExtractor.extractRules(pluginsService.getPluginsForRules(connectionId).getPluginInstancesByKeys(),
      languageSupportRepository.getAllEnabledLanguagesInConnectedMode(), true, enableSecurityHotspots);
  }
