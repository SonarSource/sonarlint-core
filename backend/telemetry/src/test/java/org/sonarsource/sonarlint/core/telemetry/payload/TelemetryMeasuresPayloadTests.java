...
class TelemetryMeasuresPayloadTests {
  ...
  void testGenerationJson() {
    ...
    assertThat(s).isEqualTo("{" +
      ...
      "{\"key\":\"binding_suggestion_clue.remote_url_accepted_count\",\"value\":\"2\",\"type\":\"integer\",\"granularity\":\"daily\"}," +
  ...
  private List<TelemetryMeasuresValue> generateMeasures() {
    ...
    values.add(new TelemetryMeasuresValue("binding_suggestion_clue.remote_url_accepted_count", String.valueOf(2), INTEGER, DAILY));
  ...
  private static void assertValues(List<TelemetryMeasuresValue> values) {
    assertThat(values).extracting("key", "value", "type", "granularity")
      ...
      .contains(tuple("binding_suggestion_clue.remote_url_accepted_count", "2", INTEGER, DAILY))
