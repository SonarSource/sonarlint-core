...
public enum SonarPlugin implements SonarArtifact {
  ...
  SONARLINT_OMNISHARP("omnisharp", Set.of(
    ...
    Dependency.on(SonarPluginDependency.OMNISHARP_MONO),
    Dependency.on(SonarPluginDependency.OMNISHARP_NET472),
    Dependency.on(SonarPluginDependency.OMNISHARP_NET6))),
  SWIFT("swift"),
