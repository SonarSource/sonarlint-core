...
class ScaApiTests {
  ...
  void should_get_issues_releases_of_vulnerability_type() {
    ...
    assertThat(issueRelease.release().packageVersion()).isEqualTo("1.0.0");
  ...
  void should_get_issues_releases_of_prohibited_license_type() {
    ...
    assertThat(issueRelease.release().packageVersion()).isEqualTo("2.1.0");
    assertThat(issueRelease.transitions()).containsExactly(
  ...
  void should_get_issues_releases_with_multiple_issues() {
    ...
    assertThat(firstIssue.release().packageVersion()).isEqualTo("1.0.0");
    ...
    assertThat(secondIssue.release().packageVersion()).isEqualTo("2.0.0");
