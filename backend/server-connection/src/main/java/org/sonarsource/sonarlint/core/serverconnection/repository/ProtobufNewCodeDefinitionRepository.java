...
/**
 * Protobuf-based implementation of NewCodeDefinitionRepository.
 */
public class ProtobufNewCodeDefinitionRepository implements NewCodeDefinitionRepository {
  private static final SonarLintLogger LOG = SonarLintLogger.get();
  public static final String NEW_CODE_DEFINITION_PB = "new_code_definition.pb";

  private final Path storageRoot;

  public ProtobufNewCodeDefinitionRepository(Path storageRoot) {
  ...
  private Path getStorageFilePath(String connectionId, String projectKey) {
    ...
    return projectStorageRoot.resolve(NEW_CODE_DEFINITION_PB);
  }
  ...
  public void store(String connectionId, String projectKey, NewCodeDefinition newCodeDefinition) {
    ...
    new RWLock().write(() -> writeToFile(newCodeDefinitionToStore, storageFilePath));
  }
