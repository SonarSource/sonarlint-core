...
/**
 * Repository abstraction for server information storage.
 */
public interface ServerInfoRepository {
  void store(String connectionId, ServerStatusInfo serverStatus, Set<Feature> features, Map<String, String> globalSettings);

  Optional<StoredServerInfo> read(String connectionId);
}
