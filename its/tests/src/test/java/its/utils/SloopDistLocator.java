...
public class SloopDistLocator {
  ...
  private static final String WINDOWS_DIST_REGEXP = "^sonarlint-process-cli-([0-9.]+)(-SNAPSHOT)*-windows.zip$";
  private static final String LINUX_64_DIST_REGEXP = "^sonarlint-process-cli-([0-9.]+)(-SNAPSHOT)*-linux_x64.tar.gz$";
