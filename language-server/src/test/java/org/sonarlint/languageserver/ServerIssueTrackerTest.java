...
public class ServerIssueTrackerTest {
  ...
  @Test
  public void should_hide_resolved_server_issues() throws IOException {
    Path baseDir = temporaryFolder.newFolder().toPath();
  ...
  @Test
  public void should_get_severity_and_issue_type_from_matched_server_issue() throws IOException {
    Path baseDir = temporaryFolder.newFolder().toPath();
    String dummyFilePath = baseDir.resolve("dummy").toString();
