...
public class SonarLintInputFile extends DefaultInputFile {
  ...
  private final org.sonarsource.sonarlint.core.AnalysisConfiguration.InputFile clientInputFile;

  public SonarLintInputFile(AnalysisConfiguration.InputFile clientInputFile) {
    super(null, null);
