...
public class GlobalTempFolderProviderTest {
  ...
  public void createTempFolderProps() throws Exception {
    ...
    TempFolder tempFolder = tempFolderProvider.provide(new GlobalConfiguration(null, workingDir.toPath()));
    tempFolder.newDir();
    tempFolder.newFile();
  ...
  public void cleanUpOld() throws IOException {
    ...
    tempFolderProvider.provide(new GlobalConfiguration(null, workingDir.toPath()));
  ...
  public void createTempFolderSonarHome() throws Exception {
    ...
    TempFolder tempFolder = tempFolderProvider.provide(new GlobalConfiguration(sonarHome.toPath(), null));
    tempFolder.newDir();
    tempFolder.newFile();
    assertThat(getCreatedTempDir(workingDir)).exists();
    assertThat(getCreatedTempDir(workingDir).list()).hasSize(2);
