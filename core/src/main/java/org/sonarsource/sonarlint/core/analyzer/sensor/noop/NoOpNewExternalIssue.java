...
public class NoOpNewExternalIssue implements NewExternalIssue {
  ...
  private static final NoOpNewIssueLocation NO_OP_ISSUE_LOCATION = new NoOpNewIssueLocation();
  ...
  @Override
  public NewExternalIssue remediationEffortMinutes(Long effortInMinutes) {
    // no op
    return this;
  }
