...
public interface ConnectedSonarLintEngine extends SonarLintEngine {
   ...
   *
   * @param projectBinding information about the project (must have been previously updated with {@link #updateProject(EndpointParams, HttpClient, String, boolean, String, ProgressMonitor)})
   ...
   * @since 2.0
   */
  void updateProject(EndpointParams endpoint, HttpClient client, String projectKey, boolean fetchTaintVulnerabilities, @Nullable String branchName, @Nullable ProgressMonitor monitor);
   ...
   * @param projectKey   key of the project (must have been previously updated with {@link #updateProject(EndpointParams, HttpClient, String, boolean, String, ProgressMonitor)})
   * @since 2.9
   */
  void downloadServerIssues(EndpointParams endpoint, HttpClient client, String projectKey, boolean fetchTaintVulnerabilities, @Nullable String branchName, @Nullable ProgressMonitor monitor);
