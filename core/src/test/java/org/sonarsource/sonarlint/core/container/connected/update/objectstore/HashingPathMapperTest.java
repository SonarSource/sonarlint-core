...
public class HashingPathMapperTest {
  @Test
  public void should_create_2_levels_of_nesting_for_level_2() {
  ...
  @Test
  public void should_create_5_levels_of_nesting_for_level_5() {
  ...
  public void should_throw_if_levels_below_1() {
    new HashingPathMapper(Paths.get("."), 0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void should_throw_if_levels_above_40() {
    new HashingPathMapper(Paths.get("."), 41);
  }
}
