...
class NewCodeServiceImplTests {

  private ConfigurationRepository mockConfigRepository;
  private StorageService mockStorageService;

  private NewCodeServiceImpl underTest;

  @BeforeEach
  void setup() {
    mockConfigRepository = mock(ConfigurationRepository.class);
    mockStorageService = mock(StorageService.class);
    underTest = new NewCodeServiceImpl(mockConfigRepository, mockStorageService, mock(TelemetryServiceImpl.class));
  }

  @Test
  void getNewCodeDefinition_noBinding() {
    var ncd = underTest.getNewCodeDefinition(new GetNewCodeDefinitionParams("scope")).join();
