...
class FileMatcherTests {
  ...
  void verify_equals_and_hashcode_of_result() {
    var r1 = new FileMatcher.Result(Paths.get("ide1"), Paths.get("sq1"));
    var r2 = new FileMatcher.Result(Paths.get("ide2"), Paths.get("sq1"));
    var r3 = new FileMatcher.Result(Paths.get("ide1"), Paths.get("sq2"));
    var r4 = new FileMatcher.Result(Paths.get("ide1"), Paths.get("sq1"));
