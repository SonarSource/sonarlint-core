...
class SonarProjectsCacheTests {
  ...
  void getTextSearchIndex_should_query_server_once() {
    ...
    var searchIndex1 = underTest.getTextSearchIndex(SQ_1, null);

    assertThat(searchIndex1.size()).isEqualTo(2);

    var searchIndex2 = underTest.getTextSearchIndex(SQ_1, null);
  ...
  void getTextSearchIndexWithProjectKey_should_query_server_once() {
    ...
    verify(serverApi.component(), times(1)).getProject(any());
  }
