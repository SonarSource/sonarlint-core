...
class AnalysisEngineFakePluginMediumTests {
  ...
  void prepare(@TempDir Path workDir) throws IOException {
    ...
    var analysisGlobalConfig = AnalysisEngineConfiguration.builder()
      ...
      .setWorkDir(workDir)
      .build();
    this.analysisEngine = new AnalysisEngine(analysisGlobalConfig, new LoadedPlugins(Map.of("python", new FakeSonarPlugin()), List.of(), List.of(), List.of()), logTester.getLogOutput());
  }
