...
public class LanguageDetectionTest {
  ...
  public void fail_if_conflicting_language_suffix() throws Exception {
    MapSettings settings = new MapSettings(Map.of(org.sonarsource.sonarlint.core.client.api.common.Language.XML.getFileSuffixesPropKey(), "xhtml",
      org.sonarsource.sonarlint.core.client.api.common.Language.HTML.getFileSuffixesPropKey(), "xhtml"));
