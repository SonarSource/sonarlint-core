...
import testutils.JUnitTempFolder;
...
public class PluginInstancesLoaderTest {
  ...
  public void plugin_entry_point_must_be_no_arg_public() {
    ...
    assertThat(expected).hasMessage("Fail to instantiate class [org.sonarsource.sonarlint.core.analysis.plugin.PluginInstancesLoaderTest$IncorrectPlugin] of plugin [fake]");
  }
  ...
  public void define_classloader() throws Exception {
    ...
    Collection<PluginClassLoaderDef> defs = loader.defineClassloaders(Map.of("foo", info), slf4jAdapter);
