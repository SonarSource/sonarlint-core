...
public class ComponentContainerTest {
  ...
  public void display_plugin_name_when_failing_to_add_extension() {
    ComponentContainer container = new ComponentContainer();
    PluginInfo plugin = mock(PluginInfo.class);
    when(plugin.getKey()).thenReturn("myPlugin");

    container.startComponents();

    IllegalStateException expected = assertThrows(IllegalStateException.class, () -> container.addExtension(plugin, UnstartableComponent.class));
    assertThat(expected.getMessage())
      .isEqualTo("Unable to register extension org.sonarsource.sonarlint.core.analysis.container.ComponentContainerTest$UnstartableComponent from plugin 'myPlugin'");
  }
