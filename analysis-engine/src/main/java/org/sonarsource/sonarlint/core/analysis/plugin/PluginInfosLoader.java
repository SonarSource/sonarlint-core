 ...
 */
package org.sonarsource.sonarlint.core.analysis.plugin;
...
import org.sonarsource.sonarlint.core.analysis.api.SkipReason;
import org.sonarsource.sonarlint.core.analysis.api.Version;
import org.sonarsource.sonarlint.core.analysis.api.SkipReason.UnsatisfiedRuntimeRequirement.RuntimeRequirement;
import org.sonarsource.sonarlint.core.analysis.plugin.PluginIndex.PluginReference;
import org.sonarsource.sonarlint.core.analysis.plugin.PluginInfo.RequiredPlugin;
import org.sonarsource.sonarlint.core.analysis.plugin.cache.PluginCache;
...
public class PluginInfosLoader {
  ...
  private final GlobalAnalysisConfiguration globalConfiguration;

  public PluginInfosLoader(PluginVersionChecker pluginVersionChecker, PluginCache pluginCache, PluginIndex pluginIndex, GlobalAnalysisConfiguration globalConfiguration,
    System2 system2) {
  ...
  private Path getFromCache(final PluginReference pluginReference) {
    ...
    if (jar == null) {
      throw new IllegalStateException("Couldn't find plugin '" + pluginReference.getFilename() + "' in the cache. Please update the binding");
    }
    return jar;
  }
}
