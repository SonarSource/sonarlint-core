...
public class UserTokenServiceDelegate extends AbstractSpringServiceDelegate<UserTokenService> implements UserTokenService {

  public UserTokenServiceDelegate(Supplier<UserTokenService> beanSupplier) {
    super(beanSupplier);
  }

  @Override
  public CompletableFuture<Void> revokeToken(RevokeTokenParams params) {
    return beanSupplier.get().revokeToken(params);
  }
