...
public class PartialUpdaterFactory {
  ...
  public PartialUpdaterFactory(ProjectStoragePaths projectStoragePaths) {
    this.projectStoragePaths = projectStoragePaths;
  }

  public PartialUpdater create() {
    return new PartialUpdater(ProtobufServerIssueStore::new, new IssueDownloader(), projectStoragePaths);
  }
}
