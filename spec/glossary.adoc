...
[[binding_clue]]Binding Clue:: For a <<configuration_scope,configuration scope>>, this is any element that could help to guess what should be the <<binding,binding>> in <<connected_mode,connected mode>>. A bindable can have multiple binding clues, partial, or even contradictory. They will be used during xref:autobinding.adoc#autobinding[auto-binding].
