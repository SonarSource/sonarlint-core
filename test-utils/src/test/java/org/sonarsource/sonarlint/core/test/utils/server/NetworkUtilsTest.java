...
class NetworkUtilsTest {
  ...
  @Test
  void getNextAvailablePort_never_returns_the_same_port_in_current_jvm() {
  ...
  @Test
  void getNextAvailablePort_retries_to_get_available_port_when_port_has_already_been_allocated() {
  ...
  @Test
  void getNextAvailablePort_does_not_return_special_ports() {
    NetworkUtils.PortAllocator portAllocator = mock(NetworkUtils.PortAllocator.class);
  ...
  @Test
  void getNextAvailablePort_throws_ISE_if_too_many_attempts() {
    NetworkUtils.PortAllocator portAllocator = mock(NetworkUtils.PortAllocator.class);
